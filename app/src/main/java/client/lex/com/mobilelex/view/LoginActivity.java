...
import client.lex.com.mobilelex.R;
import client.lex.com.mobilelex.domain.UserDataLoggin;
import client.lex.com.mobilelex.service.LogginService;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUser = (AutoCompleteTextView) findViewById(R.id.email);
    ...
    private void attemptLogin() {
        ...
        UserDataLoggin user = LogginService.getUsuer(email,password);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent next = new Intent(LoginActivity.this, DetalleActivity.class);
